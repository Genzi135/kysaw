...
import DNABackgroundPrimary from '../../assets/Product/KYSAW_Product_Logos_Ribbon_pueyvf.svg';
import DNABackgroundSecondary from '../../assets/Product/KYSAW_Product_Logos_Ribbon_short_dri7hh.svg';
import subItem from '../../assets/Product/KYSAW_Product_Logos_DNA_nip_qiosut.svg';
...
export const imgShared = {
    logos: {
        ...
        fullColor: LogoKysawFullColor
    },
    genLoveMe: {
        main: GenLoveMe,
        logo: GenLoveMeLogo,
        product: GenLoveMeProduct,
        hex: GenLoveMeHex,
        tag: GenLoveMeTag
    },
    genLoveKid: {
        main: GenLoveKid,
        logo: GenLoveKidLogo,
        product: GenLoveKidProduct,
        hex: GenLoveKidHex,
        tag: GenLoveKidTag
    },
    genLoveSkin: {
        main: GenLoveSkin,
        logo: GenLoveSkinLogo,
        product: GenLoveSkinProduct,
        hex: GenLoveSkinHex,
        tag: GenLoveSkinTag
    },
    genLoveFit: {
    ...
    genCarePre: {
        main: GenCarePre,
        logo: GenCarePreLogo,
        product: GenCarePreProduct,
        hex: GenCarePreHex,
        tag: GenCarePreTag
    },
    dnaBackground: {
        primary: DNABackgroundPrimary,
        secondary: DNABackgroundSecondary
    },
    subItem: subItem,
    partners: {
        JH: JH,
    ...
    benefit: {
        ...
        ToiUuSucKhoe: ToiUuSucKhoe,
        PhongNguaRuiRo: PhongNguaRuiRo,
    },
    about: {
        TamNhin: TamNhin,
        SuMenh: SuMenh,
