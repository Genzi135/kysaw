...
import ThongBaoCEO from '../../../../assets/notification/Thong-bao-CEO.jpg'
        ...
        <div className="mt-[70px] scroll-smooth">
            ...
            <div className="flex flex-col justify-center items-center w-full h-auto">
                <div className="w-full max-w-[1220px] flex flex-col justify-center items-center mb-10">
                    <label className="text-2xl font-manropeBold md:text-4xl p-10">Thông báo</label>
                    <Image src={ThongBaoCEO} width={900} alt="Thong bao" />
                </div>
            </div>
        </div>
    )
