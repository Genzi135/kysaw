...
const ProductData = [
    {
        ...
        introductions:
        {
            image: 'https://res.cloudinary.com/diribdgsz/image/upload/v1718808232/kysaw/contentProduct/GenLove_Fit_ev6tzt.png',
            content: ["GeneLove Fit mang đến một bước đột phá trong việc chăm sóc sức khỏe cá nhân thông qua phân tích DNA. Với GeneLove Fit, bạn sẽ hiểu rõ hơn về đặc tính chuyển hóa và dung nạp năng lượng của cơ thể từ thức ăn. Sản phẩm cung cấp thông tin chi tiết về các đặc tính di truyền liên quan đến kiểu hình cơ thể, đồng thời đưa ra khuyến cáo về chế độ dinh dưỡng và tập luyện phù hợp để cải thiện vóc dáng và sức khỏe.",
                " GeneLove Fit không chỉ giúp bạn dự đoán khả năng mắc các bệnh liên quan đến thừa cân và béo phì mà còn tạo tiền đề để nâng cao chất lượng cuộc sống. Các chỉ số được phân tích bao gồm khả năng giảm cân, nguy cơ béo phì, khả năng chuyển hóa tinh bột, khả năng chuyển hóa chất béo, và khả năng hình thành khối cơ. Nhờ đó, bạn sẽ có cái nhìn toàn diện về cơ thể mình và lựa chọn phương pháp cải thiện sức khỏe một cách hiệu quả và khoa học. ", "Hãy để GeneLove Fit đồng hành cùng bạn trên con đường chinh phục một sức khỏe tối ưu và vóc dáng lý tưởng!"]
        }

    },
    {
        productId: "genloveskin",
        productName: "GeneLove Skin",
        ...
        introductions:
        {
            image: "https://res.cloudinary.com/diribdgsz/image/upload/v1718808232/kysaw/contentProduct/GenLove_Skin_jvehbi.png",
            content: ["GeneLove Skin là giải pháp tiên tiến giúp bạn hiểu rõ hơn về đặc tính làn da của mình, từ đó đưa ra các biện pháp chăm sóc da phù hợp để duy trì vẻ đẹp trẻ trung và khỏe mạnh. Thông qua phân tích DNA, GeneLove Skin cung cấp thông tin chi tiết về cách da bạn phản ứng với các tác nhân từ môi trường như ánh sáng mặt trời, nhiệt độ, và độ ẩm.",
                " GeneLove Skin không chỉ giúp bạn nhận diện mức độ thiếu hụt chất chống oxi hóa và mức độ phá hủy Collagen sớm, mà còn đánh giá mức độ nhạy cảm của da với ánh mặt trời, khuynh hướng lão hóa sớm, và rối loạn sắc tố da.Những thông tin này sẽ là nền tảng để bạn cải thiện sức khỏe làn da và nâng cao chất lượng cuộc sống.",
                "Với GeneLove Skin, bạn sẽ có trong tay chìa khóa để tối ưu hóa quá trình chăm sóc da, từ đó giữ gìn và nâng cao vẻ đẹp tự nhiên của mình.Hãy để GeneLove Skin đồng hành cùng bạn trên hành trình khám phá và chăm sóc làn da một cách khoa học và hiệu quả!"]
        }
    },
    {
        productId: "genlovekid",
        productName: "GeneLove Kid",
        ...
        introductions:
        {
            image: "https://res.cloudinary.com/diribdgsz/image/upload/v1718808232/kysaw/contentProduct/GenLove_Kid_psrjmh.png",
            content: ["GeneLove Kid là công cụ đột phá giúp các bậc phụ huynh hiểu rõ tiềm năng di truyền của con em mình trong các lĩnh vực thể chất, tính cách, và năng lực nhận thức. Thông qua phân tích DNA, GeneLove Kid cung cấp cái nhìn sâu sắc về khả năng ngôn ngữ, ghi nhớ, cảm âm, xu hướng tính cách, sức mạnh thể chất, và nhiều yếu tố khác.",
                "GeneLove Kid không chỉ giúp bạn nhận diện các tiềm năng di truyền mà còn hỗ trợ cải thiện những hạn chế liên quan đến đặc tính di truyền của trẻ.",
                " Với thông tin về nguy cơ tăng cân, khả năng dung nạp Lactose, hấp thụ Vitamin D, và khả năng nhiễm Siêu vi, bạn sẽ có nền tảng để xây dựng chế độ dinh dưỡng và lối sống khoa học, phù hợp cho sự phát triển toàn diện của bé. GeneLove Kid giúp bạn tận dụng tối đa những thế mạnh di truyền của con, đồng thời đưa ra các biện pháp khắc phục những hạn chế, tạo điều kiện tốt nhất để trẻ phát triển khỏe mạnh và vượt trội.",
                " Hãy để GeneLove Kid đồng hành cùng bạn trong hành trình nuôi dưỡng và phát huy tối đa tiềm năng của con yêu!",],
        }

    },
    {
        productId: "genloveme",
        productName: "GeneLove Me",
        ...
        introductions:
        {
            image: "https://res.cloudinary.com/diribdgsz/image/upload/v1718808232/kysaw/contentProduct/GenLove_Me_oleivp.png",
            content: ["GeneLove Me mang đến cho bạn cơ hội khám phá và hiểu rõ tiềm lực của chính mình thông qua phân tích DNA. Sản phẩm cung cấp thông tin chi tiết về xu hướng tính cách, giúp bạn khai thác các điểm mạnh và cải thiện những hạn chế liên quan đến đặc tính di truyền. GeneLove Me còn giúp bạn khám phá khả năng ngôn ngữ, trí nhớ, và sức khỏe thể chất, tạo nền tảng vững chắc để nâng cao sức khỏe và chất lượng cuộc sống.",
                " Các chỉ số mà GeneLove Me cung cấp bao gồm tính cách, khả năng ngôn ngữ, khả năng ghi nhớ, sức mạnh và sức bền cơ bắp, nguy cơ tăng cân, khả năng dung nạp Lactose, mức độ dị ứng với đồ uống có cồn, khả năng hấp thụ Vitamin D, chất lượng giấc ngủ, và khả năng nhiễm Siêu vi. Những thông tin này giúp bạn hiểu rõ hơn về cơ thể và tính cách của mình, từ đó xây dựng lối sống và chế độ dinh dưỡng phù hợp.",
                " Hãy để GeneLove Me đồng hành cùng bạn trong hành trình khám phá bản thân, tối ưu hóa sức khỏe và nâng cao chất lượng cuộc sống. GeneLove Me - Chìa khóa mở ra tiềm năng và sức mạnh của chính bạn!"]
        }
    ...
    },
    {
        ...
        introductions:
        {
            image: "https://res.cloudinary.com/diribdgsz/image/upload/v1718808232/kysaw/contentProduct/YamuGene_mgubl4.png",
