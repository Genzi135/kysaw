...
const ProductData = [
    ...
    },
    {
        ...
        steps: [
            ...
            },
            {
                ...
                description: "Vì đặc trưng tầm soát chuyên sâu, dịch vụ này cần lấy mẫu máu. Giải trình tự DNA ngoại bào.",
                content: []
            },
            {
    ...
    },
    {
        ...
        introductions:
        {
            ...
            content: ["GenLove Fit mang đến một bước đột phá trong việc chăm sóc sức khỏe cá nhân thông qua phân tích DNA. Với GenLove Fit, bạn sẽ hiểu rõ hơn về đặc tính chuyển hóa và dung nạp năng lượng của cơ thể từ thức ăn. Dịch vụ cung cấp thông tin chi tiết về các đặc tính di truyền liên quan đến kiểu hình cơ thể, đồng thời đưa ra khuyến cáo về chế độ dinh dưỡng và tập luyện phù hợp để cải thiện vóc dáng và sức khỏe.",
    ...
    },
    {
        ...
        introductions:
        {
            ...
            content: ["GenLove Me mang đến cho bạn cơ hội khám phá và hiểu rõ tiềm lực của chính mình thông qua phân tích DNA. Dịch vụ cung cấp thông tin chi tiết về xu hướng tính cách, giúp bạn khai thác các điểm mạnh và cải thiện những hạn chế liên quan đến đặc tính di truyền. GenLove Me còn giúp bạn khám phá khả năng ngôn ngữ, trí nhớ, và sức khỏe thể chất, tạo nền tảng vững chắc để nâng cao sức khỏe và chất lượng cuộc sống.",
