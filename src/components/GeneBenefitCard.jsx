...
export default function GeneBenefitCard({ props }) {
    return (
        <div className="group relative flex justify-around items-center flex-col flex-wrap w-80 shadow-xl gap-2 p-5 rounded-md transition-transform duration-300 transform bg-white">
