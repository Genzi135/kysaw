                    ...
                    <div className="flex flex-col justify-center items-center gap-10 lg:gap-0">
                        ...
                        <div className="flex justify-center items-center gap-5 md:gap-10 p-5 mt-10 rounded-lg flex-wrap lg:flex-nowrap bg-blue-50 text-center mb-5">
                            <div className="flex justify-center items-center gap-5 md:gap-10 flex-col sm:flex-row">
                                ...
                                <label className="font-manropeBold text-lg">Dịch vụ phải tốt nhất</label>
                            </div>
                            <div className="flex justify-center items-center gap-5 md:gap-10 flex-col sm:flex-row">
            ...
            <div className="flex flex-col justify-center items-center p-5 md:p-10 gap-5 ">
                ...
                <div className="flex flex-col justify-center items-center relative p-10 border-2 max-w-[1220px] rounded-lg gap-8 mt-10">
                    ...
                    <div>
                        <label
                            onClick={() => {
                                window.open("https://kysaw.s3.ap-southeast-1.amazonaws.com/(%EC%A3%BC)JH+BIOHOLDINGS+INFORMATION_Catalog_%EC%98%81%EB%AC%B8_240610_142424.pdf")
                            }}
                            className="text-lg sm:text-xl hover:underline cursor-pointer" style={{ color: COLOR.backgroundPrimary }}>
                            Thông tin chi tiết
                        </label>
                    </div>
